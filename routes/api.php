...
Route::controller(FeaturesController::class)->group(function () {
    ...
    Route::post('features/{feature}/delete', 'delete');
});
...
Route::controller(ProjectsController::class)->group(function () {
    ...
    Route::post('projects/{project}/delete', 'delete');
...
Route::controller(UnknownsController::class)->group(function () {
    ...
    Route::post('unknowns/{unknown}/delete', 'delete');
});
...
Route::controller(TasksController::class)->group(function () {
    ...
    Route::post('tasks/{task}/delete', 'delete');
});

Route::controller(UsersController::class)->group(function () {
    Route::post('users/add', 'store');
    Route::post('users/{user}/edit', 'update');
    Route::post('users/{user}/delete', 'delete');
});
